            ...
            <div className="md:hidden">
              ...
              <div className="mt-7">
                ...
                <p className="mt-4 max-w-[520px] text-[15px] leading-relaxed text-muted">
                  Челябинская Оконная Компания (ЧОК) производит и устанавливает
                  пластиковые окна, остекляет балконы и лоджии, изготавливает
                  входные группы и алюминиевые конструкции - с 2015 года и
                  без посредников.
                </p>

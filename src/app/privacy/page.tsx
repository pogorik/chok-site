          ...
          <Container>
            ...
            <div className="mt-8 max-w-[760px] flex flex-col gap-8 text-[15px] leading-relaxed text-foreground">
              ...
              <section>
                ...
                <p className="mt-3 text-muted">
                  Для обработки заявок Оператор использует следующие сервисы,
                  которым передаются персональные данные пользователя (имя,
                  телефон):
                </p>
                <ul className="mt-3 flex flex-col gap-1.5 text-muted list-disc pl-5">
                  <li>
                    <strong>amoCRM</strong> - система учёта заявок и работы с
                    клиентами;
                  </li>
                  <li>
                    <strong>VK (ВКонтакте)</strong> - уведомление сотрудников
                    Оператора о новой заявке в рабочей беседе сообщества.
                  </li>
                </ul>
                <p className="mt-3 text-muted">
                  В остальных случаях Оператор не передаёт персональные данные
